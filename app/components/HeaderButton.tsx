    ...
    return (
        <div className="h-14 w-28 flex">
            <div className="h-full w-1/2 flex flex-wrap">
                ...
                <div className={`transition-all duration-400 h-1/2 w-1/2 flex items-center justify-center ${isClick ? 'bg-highlightVariant' : 'bg-highlight'} text-stack`}>E</div>
                <div className={`transition-all duration-400 h-1/2 w-1/2 flex items-center justify-center ${isClick ? 'bg-highlightVariant' : 'bg-highlight'} text-stack`}>N</div>
                <div className={`h-1/2 w-1/2 flex items-center justify-center bg-stack text-highlight`}>U</div>
            </div>
            <div onClick={handleButton} className={`transition-all duration-400 w-1/2 h-full ${ isClick ? 'bg-highlightVariant' : 'bg-highlight'} flex justify-center items-center flex-col cursor-pointer`}>
